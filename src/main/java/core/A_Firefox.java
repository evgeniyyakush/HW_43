...
//09 :: Current_Location
		  			report.write("09," +browser + ",index.php,Current_Location," + isElementPresent(By.id(p.getProperty("current_location_id"))) + "," +getValue(By.id(p.getProperty("current_location_id"))).replaceAll(",", "_") + "," +getSize(By.id(p.getProperty("current_location_id"))) + "," +getLocation(By.id(p.getProperty("current_location_id")))); report.write(ls);
		  System.out.println("09," +browser + ",index.php,Current_Location," + isElementPresent(By.id(p.getProperty("current_location_id"))) + "," +getValue(By.id(p.getProperty("current_location_id"))) + "," +getSize(By.id(p.getProperty("current_location_id"))) + "," +getLocation(By.id(p.getProperty("current_location_id"))));
...
//18 :: Lname_Error
					  report.write("18," +browser + ",index.php,Lname_Error," + isElementPresent(By.id(p.getProperty("Lname_Error"))) + "," +getValue(By.id(p.getProperty("lname_error_id"))) + "," +getSize(By.id(p.getProperty("lname_error_id"))) + "," +getLocation(By.id(p.getProperty("lname_error_id")))); report.write(ls);
...
// 41 :: First Name		
			      report.write("41," +browser + ",confirmation.php,First Name," + isElementPresent(By.id(p.getProperty("firstName_id"))) + "," +getValue(By.id(p.getProperty("firstName_id"))) + "," +getSize(By.id(p.getProperty("firstName_id"))) + "," +getLocation(By.id(p.getProperty("firstName_id")))); report.write(ls);
		System.out.println("41," +browser + ",confirmation.php,First Name," + isElementPresent(By.id(p.getProperty("firstName_id"))) + "," +getValue(By.id(p.getProperty("firstName_id"))) + "," +getSize(By.id(p.getProperty("firstName_id"))) + "," +getLocation(By.id(p.getProperty("firstName_id"))));
		
// 42 :: Last Name	
			   	  report.write("42," +browser + ",confirmation.php,Last Name," + isElementPresent(By.id(p.getProperty("lname_id"))) + "," +getValue(By.id(p.getProperty("lname_id"))) + "," +getSize(By.id(p.getProperty("lname_id"))) + "," +getLocation(By.id(p.getProperty("lname_id")))); report.write(ls);
		System.out.println("42," +browser + ",confirmation.php,Last Name," + isElementPresent(By.id(p.getProperty("lname_id"))) + "," +getValue(By.id(p.getProperty("lname_id"))) + "," +getSize(By.id(p.getProperty("lname_id"))) + "," +getLocation(By.id(p.getProperty("lname_id"))));
		
// 43 :: Email
			      report.write("43," +browser + ",confirmation.php,Email," + isElementPresent(By.id(p.getProperty("email_id"))) + "," +getValue(By.id(p.getProperty("email_id"))) + "," +getSize(By.id(p.getProperty("email_id"))) + "," +getLocation(By.id(p.getProperty("email_id")))); report.write(ls);
		System.out.println("43," +browser + ",confirmation.php,Email," + isElementPresent(By.id(p.getProperty("email_id"))) + "," +getValue(By.id(p.getProperty("email_id"))) + "," +getSize(By.id(p.getProperty("email_id"))) + "," +getLocation(By.id(p.getProperty("email_id"))));	

// 44 :: Phone
			   	  report.write("44," +browser + ",confirmation.php,Phone," + isElementPresent(By.id(p.getProperty("phone_id"))) + "," +getValue(By.id(p.getProperty("phone_id"))) + "," +getSize(By.id(p.getProperty("phone_id"))) + "," +getLocation(By.id(p.getProperty("phone_id")))); report.write(ls);
		System.out.println("44," +browser + ",confirmation.php,Phone," + isElementPresent(By.id(p.getProperty("phone_id"))) + "," +getValue(By.id(p.getProperty("phone_id"))) + "," +getSize(By.id(p.getProperty("phone_id"))) + "," +getLocation(By.id(p.getProperty("phone_id"))));
...
//55 :: Gender
	  	  			report.write("55," +browser + ",confirmation.php,Gender," + isElementPresent(By.xpath(p.getProperty("gender_xpath"))) + "," +getValue(By.xpath(p.getProperty("gender_xpath"))) + "," +getSize(By.xpath(p.getProperty("gender_xpath"))) + "," +getLocation(By.xpath(p.getProperty("gender_xpath")))); report.write(ls);
	 	  System.out.println("55," +browser + ",confirmation.php,Gender," + isElementPresent(By.xpath(p.getProperty("gender_xpath"))) + "," +getValue(By.xpath(p.getProperty("gender_xpath"))) + "," +getSize(By.xpath(p.getProperty("gender_xpath"))) + "," +getLocation(By.xpath(p.getProperty("gender_xpath"))));	

//56 :: State
  				    report.write("56," +browser + ",confirmation.php,State," + isElementPresent(By.xpath(p.getProperty("state_xpath"))) + "," +getValue(By.xpath(p.getProperty("state_xpath"))) + "," +getSize(By.xpath(p.getProperty("state_xpath"))) + "," +getLocation(By.xpath(p.getProperty("state_xpath")))); report.write(ls);
  		 System.out.println("56," +browser + ",confirmation.php,State," + isElementPresent(By.xpath(p.getProperty("state_xpath"))) + "," +getValue(By.xpath(p.getProperty("state_xpath"))) + "," +getSize(By.xpath(p.getProperty("state_xpath"))) + "," +getLocation(By.xpath(p.getProperty("state_xpath"))));	
		
//57 :: Terms
	  	 			report.write("57," +browser + ",confirmation.php,Terms," + isElementPresent(By.id(p.getProperty("terms_id"))) + "," +getValue(By.id(p.getProperty("terms_id"))) + "," +getSize(By.id(p.getProperty("terms_id"))) + "," +getLocation(By.id(p.getProperty("terms_id")))); report.write(ls);
		 System.out.println("57," +browser + ",confirmation.php,Terms," + isElementPresent(By.id(p.getProperty("terms_id"))) + "," +getValue(By.id(p.getProperty("terms_id"))) + "," +getSize(By.id(p.getProperty("terms_id"))) + "," +getLocation(By.id(p.getProperty("terms_id"))));	
